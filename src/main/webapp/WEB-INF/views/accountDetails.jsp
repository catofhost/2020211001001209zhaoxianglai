		...
		<div class="container">
			...
			<h1>No Order Found.</h1>
					...
					<!-- loop_start -->
						...
						<td class="cart_total">
						<%
							com.zhaoxianglai.model.Order o=(com.zhaoxianglai.model.Order)pageContext.findAttribute("o");
							int n=o.getPaymentId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							String paymentType=com.zhaoxianglai.model.Payment.findByPaymentId(con,n);
							 %>
