<%@ page import="com.zhaoxianglai.model.Product" %>
<%@ page import="java.sql.Connection" %>
<%@ page import="com.zhaoxianglai.model.Category" %>
        ...
        <div class="table-responsive col-sm-10">
            ...
            <c:forEach var="p" items="${productList}">
                <tr>
                    ...
                    <td class="">
                        <a class="cart_quantity_delete" href="<%=basePath%>admin/productEdit?${p.productId}" >
                            <i class="fa fa-edit">Edit</i></a>&nbsp;
                        <a class="cart_quantity_delete" href="<%=basePath%>admin/productDelete?${p.productId}" >
